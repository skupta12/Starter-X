...
export default function Page({ params }: { params: { url: string } }) {
  ...
  return (
    <section className="lg:pt-24 lg:pb-32 pb-16 pt-16">
      <MaxWidthWrapper>
        <div>
          ...
          sm:h-[500px] h-[300px] border border-primary-100 mb-20"
          >
            <Image
        ...
        <div className={`${styles.mdContainer}`}>
          <div>
            ...
            <figure className="mb-10">
              <div className="relative overflow-hidden h-[350px] border border-primary-100">
                <Image
                  className="object-cover"
                  fill
            ...
            <p className={`${styles.paragraph} mb-6`}>
              ...
              viverra duis maecenas a senectust condimentum massa sagittis cras
              tincidunt sit posuere augue duis est urna dictumst sed tempus arcu
              mattis viverra mauris non eu massa integer nibh nisi vestibulum
              netus.
            </p>
            <ol
            ...
            <h5 className={`${styles.heading5} mb-7`}>
              Wear professional attire that aligns with the company culture and
              industry standards
            </h5>
            ...
            <div className="black-box flex justify-center items-center bg-primary-100 py-16 my-10 relative overflow-hidden">
              <Shape
                src={Hexagon}
              ...
              <Shape
                ...
                alt="triangle"
              />
              <blockquote className="text-white lg:text-[25px] md:text-[23px] sm:text-[20px] text-[18px] font-medium leading-[1.5] text-center z-[10] p-5">
                “Varius turpis neque lectus rhoncus massa leo vulputate amet
                posuere erat condimentum amet fringilla pellentesque condimentum
                risus.”
              </blockquote>
            </div>
            <h6 className={`${styles.heading6} mb-7`}>Keep a positive attitude and demeanor throughout the interview</h6>
            <p className={styles.paragraph}>Varius amet vehicula massa pharetra pulvinar neque ipsum purus lorem mauris et aliquam risus tempus ultrices sed erat tincidunt pulvinar sollicitudin turpis condimentum sed et amet tristique vulputate donec scelerisque pellentesque suspendisse maecenas convallis lorem ut placerat laoreet rhoncus nibh pulvinar augue proin auctor eget tincidunt risus pretium augue mattis at faucibus risus venenatis.</p>
          </div>
        </div>
      </MaxWidthWrapper>
    </section>
