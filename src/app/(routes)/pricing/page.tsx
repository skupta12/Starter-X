          ...
          <MaxWidthWrapper>
            <div className="text-center mb-14 flex flex-col gap-y-5">
              ...
              <p className={`${styles.paragraph} mx-auto max-w-[50ch]`}>
                Malesuada duis ac posuere odio cras nibh amet blandit vitae
                senectus porttitor arcu volutpat ornare amet in porta volutpat
            ...
            col-span-12 border border-primary-100"
                ...
                >
                  ...
                  <div className="p-7">
                    ...
                    <ul
                      className={`list-disc list-inside flex flex-col gap-4 
