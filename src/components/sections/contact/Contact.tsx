            ...
            border bg-transparent focus:text-black border-primary-100"
              ...
              <div className="col-span-12">
                <button
                  ...
                  type="submit"
                  className={`${
                    isSubmitting ? "bg-primary-200" : "bg-primary-100"
                  } sm:w-[270px] h-[65px] w-full sm:text-[18px] font-medium px-[30px] 
                  py-[18px] inline-block hover:scale-95 duration-300 cursor-pointer 
                  border border-primary-100 text-white`}
                >
                  {isSubmitting ? (
                    <div>
                      <LoaderCircle className="animate-spin text-center mx-auto text-white " />
                    </div>
                  ) : (
                    "Send a message"
                  )}
